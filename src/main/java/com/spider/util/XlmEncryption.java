...
public class XlmEncryption {
	...
	private static Logger logger = Logger.getLogger(XlmEncryption.class);
	...
	public static boolean validatePassword(String unEncryptedPassword,String encryptedPassword) throws Exception {
		try {
